...
REM
REM Generated by Vivado on Wed Sep 16 19:38:05 +0800 2026
...
echo "xvlog --incr --relax -prj tb_led_key_vlog.prj"
call xvlog  --incr --relax -prj tb_led_key_vlog.prj -log xvlog.log
